...
public class FilaParImpar {
	public Nodo inicio = null, fim = null, aux = null;
	public FilaParImpar par, impar;
	...
	public void moverFilas(FilaParImpar fila){
		Nodo aux =  fila.inicio;
		par = new FilaParImpar();
		impar = new FilaParImpar();
		if (aux!=null){
			do{
				if (aux.num%2==0)
					par.inserir(aux.num);
				else 
					impar.inserir(aux.num);
				aux=aux.prox;
			}while(aux!= null);
		}
